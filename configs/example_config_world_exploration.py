...
_prompts_base = [
    {
        "prompt": "Under my instructions to explore a modern living room in first-person view, where bright sunlight filters through sheer curtains onto a beige sofa and wooden coffee table, creating a serene and inviting atmosphere.",
        "reference_image": "",
    },
